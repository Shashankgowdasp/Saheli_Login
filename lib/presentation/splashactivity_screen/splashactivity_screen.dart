...
import 'package:shashankgowdasp_s_application2/widgets/custom_elevated_button.dart';
import 'package:shashankgowdasp_s_application2/widgets/custom_outlined_button.dart';
import 'package:shashankgowdasp_s_application2/widgets/custom_text_form_field.dart';
...
class SplashactivityScreen extends StatelessWidget {
  ...
  TextEditingController roleselectionController = TextEditingController();
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                          ...
                          child: Container(
                              width: 231.h,
                              margin: EdgeInsets.only(top: 25.v, right: 48.h),
                              child: RichText(
                                  text: TextSpan(children: [
                                    TextSpan(
                                        text:
